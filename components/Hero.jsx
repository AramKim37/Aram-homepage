  ...
  return (
    <div className="h-screen flex flex-col space-y-4 items-center justify-center text-center overflow-hidden md:space-y-8">
      ...
      <motion.img
        ...
        src={Aram.src}
        className="relative rounded-full h-24 w-24 mx-auto object-cover border-2 border-[#f5e9e9] animate-pulse md:h-40 md:w-40"
      />
      <div className="z-20">
        <h2 className="md:text-sm text-[12px] uppercase text-gray-500 pb-2 tracking-[10px]">
          Software Engineer
        </h2>
        <h1 className="text-sm lg:text-4xl font-semibold scroll-px-10 md:text-3xl">
