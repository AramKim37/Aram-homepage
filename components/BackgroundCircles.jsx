...
const BackgroundCircles = () => {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#5725a3] rounded-full opacity-20 h-[500px] w-[500px] mt-52 animate-pulse" />
      <div className="absolute border animate-pulse border-[#c2baef] h-[700px] w-[700px] rounded-full mt-52" />
    </motion.div>
  );
};
