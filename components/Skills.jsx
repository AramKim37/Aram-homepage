  ...
  return (
    <section id="testimonials">
      <div className="flex flex-col justify-center items-center gap-5">
        ...
        <h2 className="pb-10">Testimonials</h2>
      </div>
      <Swiper
      ...
      >
        {testimonials.map((test) => (
          <SwiperSlide
            ...
            key={test.id}
          >
            <div className="flex flex-col items-center  pb-10 justify-center text-gray-500">
              <a
                href={test.link}
                className="text-gray-500 text-[40px] hover:text-[#5aa5e6] transition-all"
              >
                <BsLinkedin />
              </a>
            </div>
            <div className="text-white flex flex-col items-center justify-">
              <h5 className="text-[#5aa5e6] pb-5">{test.name}</h5>
